...
const EN = {
  ...
  "module.subagents.pool.hint": "  ↑↓ move · ←→ thinking level · Shift+↑↓ reorder · Enter swap/add · Ctrl+D delete · Esc back",
...
const ZH_CN: typeof EN = {
  ...
  "module.subagents.pool.hint": "  ↑↓ 移动 · ←→ 调思考等级 · Shift+↑↓ 排序 · Enter 换/加模型 · Ctrl+D 删除 · Esc 返回",
...
const ZH_TW: typeof EN = {
  ...
  "module.subagents.pool.hint": "  ↑↓ 移動 · ←→ 調思考等級 · Shift+↑↓ 排序 · Enter 換/加模型 · Ctrl+D 刪除 · Esc 返回",
