...
const EN = {
  ...
  "hint.filter": "  Type to filter · Enter to confirm · Esc to go back",
  "hint.back": "  Esc to go back",
  "hint.cancel": "  Esc to cancel",
  "notify.languageChanged": "Language switched to {language}",
  "notify.valueUnrecognized": "Unrecognized value {value}; keeping the current setting",
...
const ZH_CN: typeof EN = {
  ...
  "hint.filter": "  输入以过滤 · Enter 确认 · Esc 返回",
  "hint.back": "  Esc 返回上级",
  "hint.cancel": "  Esc 取消",
  "notify.languageChanged": "界面语言已切换为{language}",
  "notify.valueUnrecognized": "无法识别所选取值 {value}，已保持原设置",
  "notify.saveFailed": "{reason}",
...
const ZH_TW: typeof EN = {
  ...
  "hint.filter": "  輸入以過濾 · Enter 確認 · Esc 返回",
  "hint.back": "  Esc 返回上層",
  "hint.cancel": "  Esc 取消",
  "notify.languageChanged": "介面語言已切換為{language}",
  "notify.valueUnrecognized": "無法辨識所選取值 {value}，已保持原設定",
  "notify.saveFailed": "{reason}",
